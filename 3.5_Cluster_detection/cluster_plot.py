def cluster_plot(image_shape, filepath):
    """
    ...
    for i in range(spot.shape[0]):
        ...
        empty_image[z, x - 1, y] = 255
        empty_image[z, x - 1, y - 1] = 255
        empty_image[z, x + 3, y] = 255
        empty_image[z, x - 3, y] = 255
        empty_image[z, x + 2, y + 1] = 255
        empty_image[z, x + 2, y - 1] = 255
        empty_image[z, x + 1, y + 2] = 255
        empty_image[z, x + 1, y - 2] = 255
        empty_image[z, x - 2, y - 1] = 255
        empty_image[z, x - 2, y + 1] = 255
        empty_image[z, x - 1, y - 2] = 255
        empty_image[z, x - 1, y + 2] = 255
        empty_image[z, x, y + 3] = 255
        empty_image[z, x, y - 3] = 255
        empty_image[z, x + 3, y] = 255
        empty_image[z, x - 3, y] = 255
        empty_image[z, x + 2, y + 1] = 255
        ...
        empty_image[z, x, y + 3] = 255
        empty_image[z, x, y - 3] = 255
        empty_image[z, x + 2, y - 2] = 255
        empty_image[z, x - 2, y - 2] = 255
        empty_image[z, x + 2, y + 2] = 255
        empty_image[z, x - 2, y + 2] = 255
    return empty_image
def postcluster_detection_plot(image_shape, filepath):
    """
    :param np.shape of a image
    :param spot: spot need to be plotted
    :return: plotted image
    ...
    import numpy as np
    os.chdir(filepath)
    spot = np.load("spot_post_cluster.npy")
    empty_image = np.zeros(image_shape, dtype=np.uint8)
    z_lim = empty_image.shape[0]-1
    x_lim = empty_image.shape[1]-1
    y_lim = empty_image.shape[2]-1
    ...
    return empty_image
def postcluster_shadow_plot(image_shape, filepath):
    """
